...
Scenario: initialize initialize_client_divisions create studies show unlock study_environments self-prev-next create study_environment_sites create-cascaded_create delete 
...
Scenario: initialize initialize_client_divisions create studies list create self-update deactivate self study_environments list self-prev-next fliter_by_study create study_environment_sites create-cascaded_create delete 
...
Scenario: initialize initialize_medical_facilities create reconcile sites list self-prev-next filter_by_medical_facility-filter_by_principal_investigator create client_division_sites create study_environment_sites create-cascaded_create delete 
...
Scenario: initialize initialize_medical_facilities filter_by_curated self-prev-next create reconcile self-update unreconcile sites create client_division_sites create study_environment_sites create-cascaded_create delete 
...
Scenario: initialize initialize_medical_facilities filter_by_curated list self-prev-next create self-update sites self-prev-next create self-update client_division_sites create study_environment_sites create-cascaded_create delete 
...
Scenario: initialize initialize_client_divisions create studies self-prev-next list self-prev-next filter_by_client_division-filter_by_site create self-update study_environment_sites self-prev-next list self-prev-next filter_by_study_environment-filter_by_client_division_site create-cascaded_create self-update delete 
...
Scenario: initialize initialize_client_divisions filter_by_name create self-update studies self-prev-next list self-prev-next filter_by_parameters create lock self study_environments create self update self update study_environment_sites create-cascaded_create delete 
...
Scenario: initialize initialize_client_divisions self-prev-next-first filter_by_name self-prev-next list create create create studies create study_environment_sites create-cascaded_create delete 
